 ...
 */
package de.lindenvalley.khttp.responses

import de.lindenvalley.khttp.extensions.getSuperclasses
import de.lindenvalley.khttp.extensions.split
import de.lindenvalley.khttp.extensions.splitLines
import de.lindenvalley.khttp.requests.GenericRequest
import de.lindenvalley.khttp.requests.Request
import de.lindenvalley.khttp.structures.cookie.Cookie
import de.lindenvalley.khttp.structures.cookie.CookieJar
import de.lindenvalley.khttp.structures.maps.CaseInsensitiveMap
...
class GenericResponse internal constructor(override val request: Request) : Response {
    ...
    internal companion object {
        ...
        internal val HttpURLConnection.cookieJar: CookieJar
            get() = CookieJar(*this.headerFields.filter { it.key == "Set-Cookie" }.flatMap { it.value }.filter { !it.isNullOrEmpty() }.map { Cookie(it) }.toTypedArray())
