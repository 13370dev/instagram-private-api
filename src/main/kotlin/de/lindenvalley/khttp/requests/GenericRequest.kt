 ...
 */
package de.lindenvalley.khttp.requests

import de.lindenvalley.khttp.extensions.writeAndFlush
import de.lindenvalley.khttp.structures.authorization.Authorization
import de.lindenvalley.khttp.structures.files.FileLike
import de.lindenvalley.khttp.structures.parameters.Parameters
...
class GenericRequest internal constructor(
    ...
    companion object {
        val DEFAULT_HEADERS = mapOf(
            ...
            "User-Agent" to "de/lindenvalley/khttp/1.0.0-SNAPSHOT"
        )
