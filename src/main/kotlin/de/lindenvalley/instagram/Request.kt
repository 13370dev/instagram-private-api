...
import de.lindenvalley.khttp.get
import de.lindenvalley.khttp.post
...
class Request {
    ...
    fun prepareAsApi(reqUrl: String, jsonString: String = ""): Request {
        url = "${HTTP.ENDPOINT_API}$reqUrl"
