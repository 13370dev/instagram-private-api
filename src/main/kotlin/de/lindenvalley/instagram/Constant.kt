...
object Routes {
    ...
    fun userInfoByName(name: String): String {
        return "${name}/?__a=1"
    }

    fun mediaInfoByShortCode(shortCode: String): String {
        return "p/${shortCode}/?__a=1"
    }

    fun userPosts(name: String, maxId: String): String {
        return "${name}/media?max_id=${maxId}"
    }
    ...
    fun postsByLocation(locationId: String, slug: String): String {
        return "explore/locations/${locationId}/${slug}/?__a=1"
    }
    ...
    fun followersById(id: String): String {
        return "graphql/query/?query_id=17845312237175864&id=${id}"
    }
}
